...
namespace SMS_project.Models
{
    public class excellent_students
    {
        ...
        public string exc_stu_lev { get; set; }
        public string exc_stu_clas { get; set; }
        public string exc_stu_name { get; set; }
        public string exc_stu_nation { get; set; }
        public int exc_stu_mob { get; set; }
        public string exc_stu_birth { get; set; }
        public string exc_stu_notes { get; set; }
        public string exc_stu_eff { get; set; }
