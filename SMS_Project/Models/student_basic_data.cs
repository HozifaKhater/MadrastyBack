...
namespace SMS_Project.Models
{
    public class student_basic_data
    {
        ...
        public string transition_between_schools { get; set; }
        public string foreign_schools { get; set; }
        public string student_history_notes { get; set; }
        ...
        public string good_subject_name { get; set; }
        public int bad_subject_id { get; set; }
        public string bad_subject_name { get; set; }
