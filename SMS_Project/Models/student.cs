...
namespace SMS_Project.Models
{
    ...
    {
        public string start_year_date { get; set; }
        public int student_id { get; set; }
        public int student_file_ser { get; set; }
        public string student_civilian_id { get; set; }
        ...
        public string student_acceptance_reason { get; set; }
