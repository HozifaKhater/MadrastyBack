...
namespace SMS_Project.Models
{
    ...
    public class visits_types
    {
        ...
        public string topic_label { get; set; }
        public int is_instructions { get; set; }
        public string instructions_label { get; set; }
        public int is_job { get; set; }
        public string job_label { get; set; }
        ...
        public string vnote_label { get; set; }
        public int is_vpic { get; set; }
        public string vpic_label { get; set; }
