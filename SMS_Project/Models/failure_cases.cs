...
namespace SMS_project.Models
{
    public class failure_cases
    {
        ...
        public string fail_lev { get; set; }
        public string fail_class { get; set; }
        public string fail_student { get; set; }
        public string fail_nation { get; set; }
        public int fail_mob { get; set; }
        public string fail_birth { get; set; }
        public string fail_date { get; set; }
        public string fail_desc { get; set; }
        public string fail_reason { get; set; }
        public string fail_sub { get; set; }
        ...
        public string fail_sit { get; set; }
        public string fail_eff_date { get; set; }
        public string fail_eff_results { get; set; }
        public string fail_recomm { get; set; }
