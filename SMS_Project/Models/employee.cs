...
namespace SMS_project.Models
{
    public class employee
    {
        ...
        public string emp_civilian_id { get; set; }
        ...
        public string emp_pos_type { get; set; }
        ...
        public string emp_div { get; set; }
        public int emp_div_id { get; set; }

        public string emp_contract { get; set; }
        public int emp_contract_id { get; set; }
        public string emp_employment_date { get; set; }
        public string emp_educationa_qualification { get; set; }
        public int emp_educationa_qualification_id { get; set; }
        public string emp_educationa_qualification_date { get; set; }
        public string emp_educationa_qualification_country { get; set; }
        ...
        public string emp_mob1 { get; set; }
